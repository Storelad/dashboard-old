                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box text-center">
                            <a href="<?php echo BASE_URL; ?>" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="<?php echo LOGO; ?>" alt="logo-sm-dark" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?php echo LOGO; ?>" alt="logo-dark" height="24">
                                </span>
                            </a>

                            <a href="<?php echo BASE_URL; ?>" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="<?php echo LOGO; ?>" alt="logo-sm-light" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="<?php echo LOGO; ?>" alt="logo-light" height="24">
                                </span>
                            </a>
                        </div>
